# -*- coding: utf-8 -*-
"""
Import Dialog (Refactored) - облегчённый диалог импорта.
...
class ImportDialogRefactored(QDialog):
    """
    Диалог импорта данных из DXF в базу данных.
    
    Рефакторированная версия — делегирует бизнес-логику ImportService.
    """
    ...
    def __init__(
        ...
        Logger.log_message("Инициализация диалога импорта (refactored)")
