...
class uiADXF2Shape(QDialog, FORM_CLASS):
    ...
    def browseDXFDatei_clicked(self):
        ...
        self.current_files = AllDXFDatNames
    ...
    def btnStart_clicked(self):
        ...
        if self.listDXFDatNam.count() == 0 or (
                self.listDXFDatNam.count() == 1 and self.listDXFDatNam.item(0).text() == self.listEmpty):
